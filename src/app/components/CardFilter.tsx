...
export default function CardFilter({ event }: any) {
  ...
  return (
    <div className="rounded mb-6">
      <div
        className="w-full h-36 relative bg-black bg-opacity-25 rounded-3xl rounded-b-none shadow p-3 bg-cover bg-center"
        style={{ backgroundImage: `url(${image})` }}
      >
        <div className="text-white absolute top-3">
          <p className="text-normal font-bold pb-1">{event.title}</p>
          <div className="flex">
